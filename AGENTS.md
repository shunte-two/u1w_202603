...
## 2026-03-28 StoryAsset BGM 再生命令メモ

- StoryAsset の PlayBgm スチE��プでは、同ぁEBGM キーがすでに再生中なめEAudioManager.PlayBgm を�E実行せず無視する、E
- こ�E抑止は StoryAsset 再生経路に限定し、既存�E AudioManager API 全体�E挙動は庁E��ず最小修正で対応する、E

## 2026-03-28 ��ƃ���

- �e�`���v�^�[���B���� PlayerPrefs �֓��B�ς݃`���v�^�[��L�^���A�^�C�g����ʂ̃`���v�^�[�J�n�{�^���������Ɏg���AE
- �`���v�^�[���B�󋵂̉i�����͐�p�̕ۑ��N���X�֏W�񂵁ATitleManager �� SequenceManager ���瓯�� API ��Q�Ƃ���AE
- �^�C�g����ʂ̃`���v�^�[�I��{�^���L�����̓V�[�����̗L�������łȂ����B�󋵂�������Đ��䂵�A�Q�Ɣz���͊����� SerializeField �\����ێ�����AE

- �^�C�g����ʂ̃`���v�^�[�I��� chapter1 ��܂ߓ��B�ς݂����\�����A�����B�`���v�^�[�͖������ł͂Ȃ���\���ň����AE

## 2026-03-28 会話スキチE�E案�Eメモ

- PlayerPrefs の chapter1 到達フラグぁEON の場合、Game シーン開始時に画面左上へ「スペ�Eスキー長押しで会話スキチE�E」を 2 秒表示し、その後フェードアウトする、E
- こ�E案�E表示は Game シーン冁E�E専用 UI コンポ�Eネントで管琁E��、表示条件判定�E既存�Eチャプター到達保孁EAPI を参照する、E ConversationSkipHintOverlay はコンポ�Eネント本体を非活性化せず、CanvasGroup の alpha のみで初期非表示とフェード制御を行い、Start 未実行による再生漏れを防ぐ�
...
## 2026-03-28 �G���f�B���O�J�ڃ���

- �G���f�B���O�X�g�[���[������� `Title` �V�[���֖߂�J�ڂł́A`SequenceManager` ���� `SceneTransitionManager` �֐�p�̃t�F�[�h�C���b����n����悤�ɂ���B
- �^�C�g�����A���̃t�F�[�h�C���b���� `SequenceManager` �� `SerializeField` �ŊǗ����A�����l�� 0 �b�Ƃ��Ĉ����B

## 2026-03-28 �o�b�N���O���͐��䃁��

- ��b�o�b�N���O�\�����́A�X�y�[�X�L�[�������ɂ���b����Ǝ����i�s�X�L�b�v�𖳌�������B
- �o�b�N���O�\����Ԃ� ConversationLogPanel �̌��J��ԎQ�Ƃ��� ConversationPartManager ���󂯎��A������ SerializeField �\���̂܂ܓ��͔��肾����؂�ւ���B

## 2026-03-28 ��bEnter����������

- ��b�p�[�g�̎�������͂��� Enter �L�[��O���A�N���b�N����Ɗ����� Space �������X�L�b�v������ێ�����B
- Enter �L�[�������� ConversationPartManager �̓��͔���Ɍ��肵�A���p�[�g�� Enter ���͂�{�^���z���͂��̑Ή��ł͕ύX���Ȃ��B
## 2026-04-04 StoryAsset screen flash memo

- StoryAsset に単発の ScreenFlash ステップを追加し、会話演出中に画面フラッシュをデータ駆動で再生できるようにする。
- フラッシュの色、最大アルファ、フェードイン秒数、フェードアウト秒数は各 StoryStep のシリアライズ項目で保持する。
- フラッシュ表示は ConversationPartManager 配下の既存オーバーレイを流用し、必要な Image 参照は SerializeField で明示接続する。